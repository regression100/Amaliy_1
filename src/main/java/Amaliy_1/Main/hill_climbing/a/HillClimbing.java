package Amaliy_1.Main.hill_climbing.a;
...
//        String[] blockArr = { "2", "3", "4", "1","5" };
//        Stack<String> startState = hillClimbing.getStackWithValues(blockArr);
//        String[] goalBlockArr = { "1", "2", "3", "4","5" };
////        System.out.println(Arrays.toString(Arrays.stream(blockArr).sorted().toArray()));
...
//    }
    ...
    public static List<String> printEachStep(State state) {
