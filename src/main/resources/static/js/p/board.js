...
Board.replay = function(moves) {
    ...
    var btn = document.getElementById('replayButton'); btn && (btn.textContent = 'Toxtatish');
...
Board.clearReplay = function() {
    ...
    var btn = document.getElementById('replayButton'); btn && (btn.textContent = 'Qayta korish');
};
