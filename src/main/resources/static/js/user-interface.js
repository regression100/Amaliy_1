var UserInterface = (function () {
    ...
    function loop () {
        infoScore.innerHTML = 'Ochko: <b>' + QLearning.info.score() + (QLearning.info.score() == 1 ? ' ochko' : ' ochko') + '</b>';
        infoMissed.innerHTML = 'O\'lim: <b>' + Math.abs(QLearning.info.missed()) + (Math.abs(QLearning.info.missed()) == 1 ? ' marta' : ' marta') + '</b>';
    ...
    async function speedFaster () {
        ...
        btnTrain.innerHTML = '&vert; &vert; TALIM';
